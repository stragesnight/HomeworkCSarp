...
namespace DZ_08
{
    ...
    class Screen
    {
        ...
        public static void LogWorkerThoughts(string msg)
        {
    ...
    class Basement : IPart
    {
        ...
        public void Build()
        {
            ...
            Screen.LogProgress("Фундамент готов!");
            _isDone = true;
        }
    ...
    class Wall : IPart
    {
        ...
        public void Build()
        {
            ...
            Screen.LogProgress("Стена готова!");
            _isDone = true;
        }
        ...
        public void Draw()
        {
            ...
            {
                case Side.Back:
                    Screen.Draw(_backGraphics);
                    break;
                case Side.Right:
                    Screen.Draw(_rightGraphics);
                    break;
                case Side.Left:
                    Screen.Draw(_leftGraphics);
                    break;
                case Side.Front:
                    Screen.Draw(_frontGraphics);
                    break;
                default:
                    break;
            }
    ...
    class Door : IPart
    {
        ...
        public void Build()
        {
            ...
            Screen.LogProgress("Дверь установлена!");
            _isDone = true;
        }
    ...
    class Window : IPart
    {
        ...
        public void Build()
        {
            ...
            Screen.LogProgress("Окно установлено!");
            _isDone = true;
        }
    ...
    class Roof : IPart
    {
        ...
        public void Build()
        {
            ...
            Screen.LogProgress("Крыша установлена!");
            _isDone = true;
        }
    ...
    class Worker : IWorker
    {
        ...
        {
            Screen.LogWorkerThoughts(phrases[RNG.r.Next(phrases.Length)]);
    ...
    class TeamLeader : IWorker
    {
        ...
        public void Work(ref House house)
        {
            ...
            Screen.LogProgress("Постройка дома завершена! Нажмите любую клавишу для выхода");
        }
    }
